package dev.koenv.libraryapi.server.routes.api.v1.loans

import dev.koenv.libraryapi.server.domain.policy.LoanPolicies.requireCanBorrowBook
import dev.koenv.libraryapi.server.domain.policy.LoanPolicies.requireCanDeleteLoan
import dev.koenv.libraryapi.server.domain.policy.LoanPolicies.requireCanListLoans
import dev.koenv.libraryapi.server.domain.policy.LoanPolicies.requireCanReturnLoan
import dev.koenv.libraryapi.server.domain.service.LoanService
import dev.koenv.libraryapi.server.dto.loan.CreateLoanDto
import dev.koenv.libraryapi.server.dto.loan.ReturnLoanDto
import dev.koenv.libraryapi.server.mappers.loan.toDto
...
import dev.koenv.libraryapi.server.shared.http.RequestUtil.requireBody
import dev.koenv.libraryapi.server.shared.http.RequestUtil.requireUuidParam
import io.ktor.http.*
